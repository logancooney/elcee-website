...
export default function LinksPage() {
  return (
    <div className="min-h-screen relative" style={{ background: '#595959' }}>
      {/* Background Gradient */}
      <div 
        className="fixed inset-0 pointer-events-none"
        style={{
          background: 'linear-gradient(180deg, #2E2E2E 50%, #595959 100%)',
          zIndex: 0,
        }}
      />

      {/* Hero Section with Image */}
      <div className="relative h-[300px] -mx-5 -mt-5 overflow-hidden">
        ...
        <div 
          className="absolute inset-0"
          style={{
            background: 'linear-gradient(180deg, rgba(0, 0, 0, 0) 70%, #2E2E2E 100%)',
          }}
        />
      </div>

      {/* Main Content */}
      <div className="relative z-10 max-w-2xl mx-auto px-5 pb-20" style={{ marginTop: '-80px' }}>
        
        {/* Profile Section */}
        <div className="flex flex-col items-center mb-10">
          <div className="w-28 h-28 mb-4 rounded-full overflow-hidden ring-4 ring-white/10">
            <img src="/icon.png" alt="Elcee the Alchemist" className="w-full h-full object-cover" />
          </div>
          <h1 className="text-[28px] font-extrabold text-white text-center mb-2" style={{ fontWeight: 800 }}>
            Elcee the Alchemist
          </h1>
          <p className="text-white/70 text-base font-light">Alternative Rap | Manchester</p>
        </div>
        ...
        <div className="space-y-3 mb-10">
          ...
          <a
            ...
            className="block w-full text-center py-5 px-6 rounded-lg transition-all hover:bg-white/10"
            style={{
              background: 'rgba(28, 28, 28, 0.6)',
              backdropFilter: 'blur(10px)',
            }}
          >
            <span className="text-white text-lg font-semibold">🎙️ Book Studio Time</span>
          </a>
          ...
          >
            <span className="text-white text-lg font-semibold">🎵 Listen on Spotify</span>
          </a>
        ...
        {/* Music Platforms */}
        <div className="mb-10">
          <h2 className="text-xl font-semibold text-white mb-4">Listen Everywhere</h2>
          <div className="grid grid-cols-2 gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center py-4 px-4 rounded-lg transition-all hover:bg-white/10"
              style={{
                background: 'rgba(28, 28, 28, 0.6)',
                backdropFilter: 'blur(10px)',
              }}
        ...
        <div className="text-center mb-8">
          <a
            href="/contact"
            className="inline-block text-white/70 hover:text-white transition text-sm font-light"
          >
            Contact
          </a>
